...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 14-06-2024 a las 15:40:47
...
INSERT INTO `productos` (`id_producto`, `nombre`, `precio`, `stock`, `imagen_url`) VALUES
...
INSERT INTO `sesiones` (`id`, `usuario_id`, `token`, `fecha_inicio`, `fecha_expiracion`) VALUES
(2, 2, '199dede32e81ef88d4eefff0719b63c5', '2024-06-14 13:34:19', '2024-06-14 14:34:19');
...
(2, 'Alonso', 'alonsogonzalezdeaguilar3@gmail.com', '$2y$10$X7GU2FSlvp5SPomYvaT5FecpfpIvpiR9JRQuHKlnOoqMRTyQx0C.q', '2024-06-14 13:34:08');
...
--
ALTER TABLE `pedidos`
  MODIFY `id_pedido` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT de la tabla `productos`
--
ALTER TABLE `productos`
  MODIFY `id_producto` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=45;
...
--
ALTER TABLE `pedidos`
  ADD CONSTRAINT `pedidos_ibfk_1` FOREIGN KEY (`id_usuario`) REFERENCES `sesiones` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `tarjeta`
  ADD CONSTRAINT `tarjeta_ibfk_1` FOREIGN KEY (`id_pedido`) REFERENCES `pedidos` (`id_pedido`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
